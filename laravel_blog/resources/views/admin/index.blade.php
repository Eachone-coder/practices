...
@section('content')
    ...
    <div class="top_box">
        <div class="top_left">
            ...
            <ul>
                ...
                <li><a href="{{url('admin/info')}}" target="main" class="info">管理页</a></li>
            </ul>
        </div>
        <div class="top_right">
            <ul>
        ...
        <ul>
            <li>
                ...
                <ul class="sub_menu">
					...
					<li><a href="{{url('admin/visitor')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>访客列表</a></li>
                </ul>
            </li>
            <li>
    ...
    <div class="bottom_box">
        CopyRight © 2016.{{date('Y')}} Powered By <a href="http://zhaojiaxing.top">http://zhaojiaxing.top</a>.
    </div>
    <!--底部 结束-->
@endsection
