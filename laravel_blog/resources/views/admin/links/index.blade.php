...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; <a href="#">友情链接管理</a>
    </div>
    <!--面包屑导航 结束-->
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td class="tc">
                            <input type="text" style="width:40px" name="ord[]" onchange="changeOrder(this,{{$v->link_id}})" value="{{$v->link_order}}">
                        </td>
