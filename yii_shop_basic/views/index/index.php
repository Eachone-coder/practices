                ...
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div class="gallery-thumbs clearfix">
                        <ul>
                            ...
                            <?php foreach ((array)json_decode($last->pics, true) as $key => $pic): ?>
                                <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="<?php echo $key; ?>" href="#slide<?php echo $key; ?>"><img alt="" src="<?php echo $pic ?>-picsmall" data-echo="<?php echo $pic ?>-picsmall" /></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </div><!-- /.gallery-thumbs -->
